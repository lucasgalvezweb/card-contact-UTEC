...
<body>
    <div class="background">
        <div class="logo-utec text-center">
            <img src="elements/UTEC.png" width="100px" alt="Foto Javier Bustamante" />
        </div>
        <div class="profile-image text-center">
            <img src="elements/Foto_Javier.png" width="250px" alt="Foto Javier Bustamante" />
        </div>
    </div>

    <div class="main">
        <div class="info text-center">
            <h1 class="title h3">JAVIER BUSTAMANTE</h1>
            <div class="subtitle-wrapper">
                <span class="subtitle h5">DIRECTOR GENERAL</span>
            </div>
        </div>

        <div class="icons-to-contact row text-center">
            <div class="col-3">
                <a href="tel:+511-230-5000"><img src="elements/Phone.png" width="35px" alt="" /></a>
            </div>
            <div class="col-3">
                ...
                <li>
                    <div class="row">
                        ...
                        <div class="col-9">
                            ...
                            <span><a href="tel:+511-230-5000">Teléfono fijo</a></span>
                        </div>
                    </div>
                </li>
                <!-- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> -->
        ...
        <div class="add-contact">
            <a href="elements/jbustamante.vcf" download><img src="elements/contacto.png" width="250px" alt=""></a>
        </div>
    </div>
</body>
